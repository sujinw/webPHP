<?php /* Smarty version 2.6.26, created on 2016-03-19 18:25:30
         compiled from E:/WEBPROJECT/PHP/GZCms/application/Admin/Tpl/Login/Index.html */ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
    ...
    <title>格子原创平台-后台登录</title>
    <link rel="shortcut icon" type="image/x-icon" href="favicon.ico" />
    <!-- CSS -->
    <link href="<?php echo @__CSS__; ?>
...
?m=admin&c=login&a=index" method="post">
    <p style="padding: 30px 0px 10px 30px;position: relative;">
        <span class="u_logo"></span>
        <input class="ipt" type="text" name="username" placeholder="请输入用户名">
    </p>
    <p style="padding: 0px 0px 10px 30px;position: relative;">
    ...
    <div style="height: 50px;line-height: 50px;margin-top: 30px;border-top: 1px solid #e7e7e7;">
        <p style="margin: 0px 35px 20px 45px;">
           ...
           <span style="float: right">
             <button type="submit" style="background: #008ead;padding: 7px 10px;border-radius: 4px;border: 1px solid #1a7598;color: #FFF;font-weight: bold;">登录后台</button>
           </span>
        </p>
    </div>
    </form>
...
<div style="position: fixed;bottom: 0px;text-align: center;width: 100%;">
    Copyright ©2015 <a style="margin-left: 10px;color: #000000;text-decoration: underline" href="http://www.sevennight.cn">http://www.zukmb.cn.cn</a>
</div>
</body>
</html>