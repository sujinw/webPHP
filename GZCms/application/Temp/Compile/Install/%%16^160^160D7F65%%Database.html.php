<?php /* Smarty version 2.6.26, created on 2016-03-25 16:44:42
         compiled from E:/WEBPROJECT/PHP/GZCms/application/Install/Tpl/Index/Database.html */ ?>
        ...
        <form onsubmit="return false;" method="post" class="hd-form">
            ...
            <div class="btn">
                <button class="hd-btn" type="button"
                        onclick="location.href='<?php echo @__APP__; ?>
?m=install&a=environment'">上一步
                </button>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<script>
    ...
    $("form").submit(function () {
        //异步验证数据库连接
        $.post("index.php?m=install&a=Database", $(this).serialize(), function (json) {
            if (json.status == 1) {
                location.href = "index.php?m=install&a=Complete";
            } else {
                hd_alert({
