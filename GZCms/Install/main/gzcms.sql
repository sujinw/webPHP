...
-- ----------------------------
-- Table structure for gz_access
-- ----------------------------
DROP TABLE IF EXISTS `gz_access`;
CREATE TABLE `gz_access` (
...
CREATE TABLE `gz_article` (
  ...
  PRIMARY KEY (`aid`)
) ENGINE=MyISAM AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='文章表';

-- ----------------------------
-- Table structure for gz_article_category
-- ----------------------------
DROP TABLE IF EXISTS `gz_article_category`;
CREATE TABLE `gz_article_category` (
...
-- ----------------------------
-- Table structure for gz_article_reply
-- ----------------------------
DROP TABLE IF EXISTS `gz_article_reply`;
CREATE TABLE `gz_article_reply` (
  ...
  PRIMARY KEY (`rid`)
) ENGINE=MyISAM AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='文章评论表';
...
CREATE TABLE `gz_config` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='网站配置表';

-- ----------------------------
-- Table structure for gz_message_receiver
-- ----------------------------
DROP TABLE IF EXISTS `gz_message_receiver`;
CREATE TABLE `gz_message_receiver` (
  `rid` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`rid`)
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='站内信收件人信息表';

-- ----------------------------
-- Table structure for gz_message_sender
-- ----------------------------
DROP TABLE IF EXISTS `gz_message_sender`;
CREATE TABLE `gz_message_sender` (
  ...
  PRIMARY KEY (`mid`)
) ENGINE=MyISAM AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='用户站内信发件人信息表';

-- ----------------------------
-- Table structure for gz_node
-- ----------------------------
DROP TABLE IF EXISTS `gz_node`;
CREATE TABLE `gz_node` (
  ...
  KEY `pid` (`pid`),
  KEY `status` (`status`)
) ENGINE=MyISAM AUTO_INCREMENT=17 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='权限节点表';
...
CREATE TABLE `gz_role` (
  ...
  KEY `pid` (`pid`),
  KEY `status` (`status`)
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='权限角色表';

-- ----------------------------
-- Table structure for gz_role_user
-- ----------------------------
DROP TABLE IF EXISTS `gz_role_user`;
CREATE TABLE `gz_role_user` (
...
-- ----------------------------
-- Table structure for gz_template
-- ----------------------------
DROP TABLE IF EXISTS `gz_template`;
CREATE TABLE `gz_template` (
  ...
  PRIMARY KEY (`tid`)
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='网站模板表';
...
CREATE TABLE `gz_user` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=23 DEFAULT CHARSET=utf8 COMMENT='格子用户表';

-- ----------------------------
-- Table structure for gz_userlever
-- ----------------------------
DROP TABLE IF EXISTS `gz_userlever`;
CREATE TABLE `gz_userlever` (
...
) ENGINE=MyISAM AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COMMENT='格子用户等级表';

-- ----------------------------
-- Table structure for gz_userlogin
-- ----------------------------
DROP TABLE IF EXISTS `gz_userlogin`;
CREATE TABLE `gz_userlogin` (
  `uid` int(11) NOT NULL AUTO_INCREMENT,
  `login_time` int(10) DEFAULT '0' COMMENT '登录的时间',
  `login_ip` int(11) DEFAULT '0' COMMENT '登录的ip',
  PRIMARY KEY (`uid`)
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='格子用户登录信息记录表';

-- ----------------------------
-- Table structure for gz_zan
-- ----------------------------
DROP TABLE IF EXISTS `gz_zan`;
CREATE TABLE `gz_zan` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) DEFAULT NULL COMMENT '用户id',
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='点赞表';
