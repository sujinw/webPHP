<?php /* Smarty version 2.6.26, created on 2015-12-10 20:33:34
...
?c=Column&a=add"  target="appiframe" class="list-group-item"><span class="glyphicon glyphicon-menu-right"></span> 添加栏目</a>
                    ...
                    <div class="panel panel-inner">
                        ...
                        <div id="collapseSix" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingSix">
                            <div class="list-group list-group-self">
                                <a href="config.html"  target="appiframe" class="list-group-item"><span class="glyphicon glyphicon-menu-right"></span> 系统设置</a>
                            </div>
                        </div>
                    </div>
                    <div class="panel panel-inner">
