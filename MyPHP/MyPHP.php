...
final class Appcation {
	...
	private static function _set_const(){
		...
		//定义插件目录
		define("APP_ADDON_PATH",	ROOT_PATH . APP_PATH."/Addon");
		...
		define("APP_COMMON_HOOK_PATH",		APP_COMMON_PATH . '/Hook');
		//==============================设置模块常量
	...
	private static function _create_dir(){
		...
		foreach ($m as $v) {
			...
			is_dir(ROOT_PATH.APP_PATH.'/'.$v. '/' .APP_HOOK_PATH) || mkdir(ROOT_PATH.APP_PATH.'/'.$v. '/' .APP_HOOK_PATH,0777,true);
	...
	private static function _import_file(){
		$fileArr = array(
			...
			MYPHP_CORE_PATH 	. '/Router.class.php',
			MYPHP_CORE_PATH 	. '/Hook.class.php'
		);
